...
def test_terminal(selenium, url):
    ...
    selenium.find_element(By.CSS_SELECTOR, ".xterm-helper-textarea").send_keys("jupyter --version") 
    selenium.find_element(By.CSS_SELECTOR, ".xterm-helper-textarea").send_keys(Keys.ENTER) 
    sleep(1)
    selenium.get_screenshot_as_file(f'screenshots/aiidalab-terminal.png')
