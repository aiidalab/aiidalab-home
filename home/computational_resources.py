...
# Vendored from:
# - aiidalab-widgets-base/aiidalab_widgets_base/computational_resources.py
# - aiidalab-widgets-base/aiidalab_widgets_base/databases.py
# - aiidalab-widgets-base/aiidalab_widgets_base/utils/__init__.py
# Source commit: eb7489aa707499d0fe3677414bcbe3825933769f
...
class SshComputerSetup(ipw.VBox):
    ...
    def _on_verification_mode_change(self, _=None):
